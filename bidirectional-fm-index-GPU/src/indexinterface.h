...
class IndexInterface {
  protected:
    ...
    void recApproxMatchEdit(
        ...
        const std::vector<Substring>& parts, Counters& counters, GPUBuffer& buffer,
        const int& idx = 1,
    ...
    bool branchAndBound(IBitParallelED* bpED, MatrixMetaInfo& cluster,
                        ...
                        Counters& counters, GPUBuffer& buffer,
  ...
  public:
    ...
    void recApproxMatchEditEntry(const Search& search, const FMOcc& startMatch,
                                 Occurrences& occ,
                                 const std::vector<Substring>& parts,
                                 Counters& counters, GPUBuffer& buffer, const int& idx = 1);
    ...
    virtual void verifyExactPartialMatchInText(
        ...
        const length_t& maxED, Occurrences& occ, Counters& counters, GPUBuffer& buffer,
