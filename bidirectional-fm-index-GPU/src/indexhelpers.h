...
class Occurrences {
  ...
  public:
    ...
    void addFMOccs(std::vector<FMOcc>& occs) {

        inFMOcc.insert(inFMOcc.end(), std::make_move_iterator(occs.begin()),
    ...
    std::vector<FMOcc>& getFMOccurrencesMutable(){
        return inFMOcc;
    }
 ...
 */
template <typename WordType> class InTextVerificationTaskCPU {
  ...
  public:
    InTextVerificationTaskCPU(const std::vector<Substring>& refs,
