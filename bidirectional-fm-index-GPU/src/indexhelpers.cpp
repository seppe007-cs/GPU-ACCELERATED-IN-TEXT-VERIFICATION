...
void InTextVerificationTaskCPU<WordType>::doTask(Counters& counters,
                                              Occurrences& occ) {
...
template class InTextVerificationTaskCPU<uint64_t>;
template class InTextVerificationTaskCPU<UInt128>;
